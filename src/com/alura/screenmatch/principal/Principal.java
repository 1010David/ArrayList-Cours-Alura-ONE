...
public class Principal {
    public static void main(String[] args) {
        ...
        System.out.println("Tamaño of list: " + listaDePelis.size());
        System.out.println("La primera peli es: " + listaDePelis.get(0).getNombre());
        System.out.println(listaDePelis);
        System.out.println("toString de la pelicula: " + listaDePelis.get(0).toString());
